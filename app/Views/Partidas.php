...
<head>
  ...
  <main id="wrapper" >
    ...
    <div id="page-content-wrapper">
     <nav class="navbar navbar-dark" style="background-color : #1a2732">
      ...
      <div class="container-fluid">
        <div class="navbar-header"><label class="icon-th-list" id="menu-toggle"  data-toggle="tooltip" title="Menú"></label>
          ...
          <a class="navbar-brand font-weight-bold text-white" >PARTIDAS PRESUPUESTALES</a>
        </div>
          <div class="col-sm-6" >
            <label class="sr-only">Buscar</label>
            <input type="text" class="form-control form-control-sm" placeholder="Buscar" name="buscar" id="buscar" data-model="Partidas" autocomplete="off">
          </div>
        <div class="dropdown ">
    ...
    <div class="contentPage animate-bottom">
        ...
        <div class="col-sm-12 alert-color">
          <img src="<?php echo PATH_PUBLIC ?>/img/add.png">
            <label class="font-weight-bold">
              REGISTRO DE PARTIDA PRESUPUESTALES</label>
        </div>
      </div>
      <div class="row">
          <div class="form-group col-sm-1.5 p-3" >
              <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#ventana" style="float:right" data-id="0" data-model="Partidas" data-operation="Agregar" data-method="requested">
      ...
      <div class="row">
        <div class="col-sm-12">
          <label class=" form-control text-center font-weight-bold" style="border: white;">
            <img src="<?php echo PATH_PUBLIC ?>/img/lista.png"> LISTA DE PARTIDA PRESUPUESTALES</label>
        </div>
      </div>
            ...
            <thead class="thead-dark">
              ...
              <tbody class="container-table">
                ...
                <tr>
                  ...
                  <td>
                    <center>
                      <button type="button" class="btn btn btn-outline-info btn-sm badge badge-pill" data-toggle="modal" data-target="#ventana" data-id="<?= $r["IdPartida"] ?>" data-model="Partidas" data-operation="Editar" data-method="requested">
                  ...
                  <td>
                    <center>
                      <button type="button" class="btn btn btn-outline-danger btn-sm badge badge-pill" data-toggle="modal" data-target="#ventana" data-id="<?= $r["IdPartida"] ?>" data-model="Partidas" data-operation="Eliminar" data-method="delete">
